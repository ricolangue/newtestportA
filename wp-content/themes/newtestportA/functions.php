...
function twentysixteen_widgets_init()
{
	...
	register_sidebar(array(
		'name' => __('Middle Box Float 1', 'twentyten'),
		'id' => 'mid_box_float1',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Middle Box Float 2', 'twentyten'),
		'id' => 'mid_box_float2',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Middle Box Float 3', 'twentyten'),
		'id' => 'mid_box_float3',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Contact Information Heading', 'twentyten'),
	...
	register_sidebar(array(
		'name' => __('Contact Information List 1', 'twentyten'),
	...
	register_sidebar(array(
		'name' => __('Contact Information List 2', 'twentyten'),
	...
	register_sidebar(array(
		'name' => __('About Us Main Content', 'twentyten'),
		'id' => 'about_main',
		'description' => __('The primary widget area', 'twentyten'),
	...
	register_sidebar(array(
		'name' => __('About Us Mission', 'twentyten'),
		'id' => 'about_mission',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('About Us Vision', 'twentyten'),
		'id' => 'about_vision',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Main', 'twentyten'),
		'id' => 'services_main',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Box 1', 'twentyten'),
		'id' => 'services_box_1',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Box 2', 'twentyten'),
		'id' => 'services_box_2',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Box 3', 'twentyten'),
		'id' => 'services_box_3',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Box 4', 'twentyten'),
		'id' => 'services_box_4',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Box 5', 'twentyten'),
		'id' => 'services_box_5',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('Services Box 6', 'twentyten'),
		'id' => 'services_box_6',
		'description' => __('The primary widget area', 'twentyten'),
		'before_widget' => '<div class="widget-container %2s">',
		'after_widget' => '</div>',
			...
			case 'trackback':
				...
				<li class="post pingback">
					<p><?php _e('Pingback:', 'twentyten'); ?>
						<?php comment_author_link(); ?> 				<?php edit_comment_link(__('(Edit)', 'twentyten'), ' '); ?>
					</p>
					<?php
					break;
		endswitch;
...
function query_page_title($page_title)
{
