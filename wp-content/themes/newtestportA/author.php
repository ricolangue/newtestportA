			...
			<main>
				...
				if ($loop->have_posts()):
					while ($loop->have_posts()):
						$loop->the_post(); ?>
						<div class="blog_cont">
							<div id="post-<?php the_ID(); ?>" <?php if (($postCount <= 2 && $postCount > 0) && $paged == 0) {
								...
								<div class="img_wrapper">
									...
									<?php } else { ?>
											<img id="logodefault" src="<?php bloginfo("template_url") ?>/images/blog/default.png"
								...
								<div class="info_cont">
									<h2 class="blog_heading"><a
											href="<?php the_permalink(); ?>"><?php echo wp_trim_words(get_the_title(), 11, '...'); ?></a>
									</h2>
					...
					<?php endwhile;
					kriesi_pagination(); // end of the loop.
				else: ?>
