					...
					<div class="footer_right">
						<div class="footer_logo">
							<a href="<?php echo get_home_url(); ?>">
								<figure><img src="<?php bloginfo('template_url'); ?>/images/footer-logo.png"
						...
						<div class="copyright">
							...
							echo $copyright;
							?>
							<span class="footer_comp"><?php //echo get_bloginfo('name'); ?><a class="privacy_pol"
						...
						<div class="social_media jello-horizontal">
							<ul>
								<li><a href="https://www.facebook.com" target="_blank">
										<figure><img src="<?php bloginfo('template_url'); ?>/images/icons/fb-icon.png"
												alt="facebook"></figure>
									</a></li>
								<li><a href="https://www.twitter.com" target="_blank">
										<figure><img
												src="<?php bloginfo('template_url'); ?>/images/icons/twitter-icon.png"
												alt="twitter"></figure>
									</a></li>
							</ul>
						</div>
