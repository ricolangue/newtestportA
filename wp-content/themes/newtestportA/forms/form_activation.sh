...
scrn_directory='D:\RICLANGUE-FILES\'$folderA'\'$tempFolder'\'$folderB'\'$myfolderA'\'$client_web'\screenshot'
...
cscript //nologo "textReplace.vbs" "page_name" "$page_name" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
...
read -p "Enter number of form pages converted:" num_page_converted 
while [[ "${num_page_converted}" == "" ]] ; do
   read -p "Enter number of form pages converted:" num_page_converted 
done
cscript //nologo "textReplace.vbs" "num_page_converted" "$num_page_converted" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
#num_page_converted

#fillable_form_title 
read -p "Enter form title:" fillable_pdf_form_title 
while [[ "${fillable_pdf_form_title}" == "" ]] ; do
   read -p "Enter form title:" fillable_pdf_form_title  
done
cscript //nologo "textReplace.vbs" "fillable_pdf_form_title" "$fillable_pdf_form_title" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
...
then
	...
	cscript //nologo "textReplace.vbs" "scrn_file_path" "$scrn_file_path" ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/$file_name
else
    #scrn_out=""
