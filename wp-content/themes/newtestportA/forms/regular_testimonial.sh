...
then
	...
	#echo "notepad.exe $regular_testimonial_guide" > ./$folderA/$tempFolder/$folderB/$myfolderA/$client_web/regular_testimonial_guide.bat
...
#config_email
read -p "Enter wordpress email:" config_email 
