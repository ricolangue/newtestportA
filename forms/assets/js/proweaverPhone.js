$(function () {
    ...
    function countryHolder() {
        ...
        $('.cphone').on('focus change paste keyup', function() {
            ...
            if ($(this).val() == '') {
                // Preserve the selected country's phone code in the placeholder
                var selectedCountry = $('.country-holder li.selected');
                var phoneCode = selectedCountry.length ? selectedCountry.data('code') : "+1";
                $(this).mask(phoneCode + ' 000000000000');
                $(this).attr('placeholder', phoneCode + ' (phone number)');
            }
        });
        ...
        $('.country-holder li').on('click', function() {
            ...
            // Mark the country as selected
            $('.country-holder li').removeClass('selected');
